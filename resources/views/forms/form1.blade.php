            ...
            <div class="col-md-9 ms-paper-content-container">
                <div class="ms-paper-content">
                    ...
                    <section class="ms-component-section">
                        <h2 class="section-title">Basic Form</h2>
                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group" style="margin-top: 0;">
                                    ...
                                    <div class="col-md-offset-2 col-md-10">
                                        <div class="checkbox">
                                            ...
                                            <label>
                                                <input type="checkbox" disabled=""> Disabled Checkbox </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="radio radio-primary">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked=""> Option one is this </label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2"> Option two can be something else </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select id="select222" multiple="" class="selectpicker form-control" data-dropup-auto="false">
                                            <option>Ea nam qui vel consequatur</option>
                                            <option>Dolorem perspiciatis adipisci </option>
                                            <option>Aperiam, debitis deleniti</option>
                                            <option>Accusamus non qui amet eum</option>
                        ...
                        <div class="panel panel-info panel-code">
                            <div class="panel-heading panel-code-heading" role="tab" id="codeHead1">
                                <h4 class="panel-title panel-code-title">
                            ...
                            <div id="code1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="codeHead1">
                                <div class="panel-code-body"> <pre><code class="language-markup line-numbers">&lt;form class=&quot;form-horizontal&quot;&gt;
    &lt;fieldset&gt;
        &lt;legend&gt;Legend&lt;/legend&gt;
        &lt;div class=&quot;form-group&quot;&gt;
            &lt;label for=&quot;inputEmail&quot; class=&quot;col-md-2 control-label&quot;&gt;Email&lt;/label&gt;
...
&lt;/form&gt;
                    ...
                    <section class="ms-component-section">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control input-sm" type="text" id="inputSmall"> </div>
                        <div class="form-group">
