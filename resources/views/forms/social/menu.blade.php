            ...
            <ul class="panel-group ms-collapse-nav" id="components-nav" role="tablist" aria-multiselectable="true">
                <li>
                    <a class="withripple" href="#">
                        <i class="fa fa-arrow-circle-right"></i> Facebook</a>
                </li>
                <li>
                    <a class="withripple" href="#">
                        <i class="fa fa-arrow-circle-right"></i> Linkendin</a>
                </li>
                <li>
                    <a class="withripple" href="#">
                        <i class="fa fa-arrow-circle-right"></i> Twitter</a>
                </li>
                <li>
                    <a class="withripple" href="#">
                        <i class="fa fa-arrow-circle-right"></i> Instagram</a>
                </li>
            </ul>
            <!-- ms-collapse-nav -->
        </div>
