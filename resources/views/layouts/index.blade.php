...
<head>
    ...
    <meta name="description" content="Mine Data">
...
<div class="sb-site-container">
    ...
    @yield('slider')
    @yield('card_block')
    @yield('circle_counter')
    @yield('tickers')
    @yield('our_team')
    @yield('form1')
    @yield('financeaccounts')
    @yield('searchaccounts')
    @yield('healthaccounts')
    @yield('socialaccounts')
