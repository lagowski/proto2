...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::asset('img/favicon.png?v=3')}}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    <link rel="stylesheet" href="{{ URL::asset('css/preload.min.css')}}" />
    <link rel="stylesheet" href="{{ URL::asset('css/plugins.min.css')}}" />
    <link rel="stylesheet" href="{{ URL::asset('css/style.light-blue-500.min.css')}}" />
    <!--[if lt IE 9]>
...
<div class="sb-site-container">
    ...
    <header class="ms-hero-page ms-hero-img-keyboard ms-hero-bg-dark color-white">
        <div class="container index-1">
            <div class="col-md-6">
                <h1 class="text-uppercase animated fadeInDown animation-delay-5 typed-title">The power to create
                    <br>
            ...
            <div class="col-md-6 text-center mt-4">
                <div class="img-phone-container">
                    <img class="img-responsive animated zoomInDown animation-delay-3 index-1" src="assets/img/demo/pixel1.png">
                    <img class="img-responsive img-phone-left" src="assets/img/demo/pixel3.png">
                    <img class="img-responsive img-phone-right" src="assets/img/demo/pixel2.png"> </div>
            </div>
            <div class="col-md-12">
...
<script src="{{ URL::asset('js/home-generic-6.js')}}"></script>
</body>
</html>